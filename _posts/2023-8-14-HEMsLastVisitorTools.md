...
I knew before I started the project that the He Art Museum would be the backdrop for the plant animation. As I continued to piece things together, this idea kept creeping in about how these large public spaces would change if we weren't around. I decided that my plant would be one of the last to visit the museum. After completing the structure, I set out to create a few tools to quickly "dress" every surface with a happy little visitor. In this brief breakdown, I'll walk you through a few of the tools I created to speed things along.
